...
fun RegisterScreen(
    ...
    LaunchedEffect(uiState.isUserRegistered, uiState.registeredUser) {
        when {
            uiState.registeredUser != null -> navigateToHome()
            uiState.isUserRegistered && uiState.infoMessage != null -> navigateBack()
        }
    }
        ...
        Box(Modifier.fillMaxSize()) {
            Column(
                ...
                CustomTextField(
                    ...
                    label = label,
                    onValueChange = registerViewModel::onInputChanged,
                )

                AnimatedVisibility(visible = uiState.mode == MY_MODE.EMAIL) {
                    Column {
...
fun RegisterScreenPreview() {
    RegisterScreen(navigateBack = {}, navigateToHome = {})
}
